...
class Ranged_Player: # Template for ranged player classes
    ...
    def reload(self: Enum): # Cannot reload at full ammo. It will make you reselect action if attempted. This is also how self.tatical_reload_evasion_modifier is set to True
